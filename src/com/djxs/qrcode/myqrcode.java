...
public class myqrcode {
	public static void main(String[] args) throws IOException {
		...
		String str="BEGIN:VCARD\n"+
                   "PHOTO;VALUE=http://img5.dwstatic.com/lol/1603/322852568002/1458897488919.png\n" +
                   "FN:姓名:高玉坡\n"+
                   "TITLE:河北科技师范学院学生\n"+
                   "ADR;WORK:;;秦皇岛海港区西港镇河北大街西段360号\n"+
                   "TEL;CELL,VOICE:10010111\n"+
                   "TEL;WORK,VOICE:13025420\r\n"+
        ...
        Image logo=ImageIO.read(new File("D:/djxsQrcode/zhuxinglongwang.png"));
        int logosize=50;
